...
MongoClient.connect('mongodb://itnadmin:itnUser0136!@ds153700.mlab.com:53700/itnsoutherndelaware', function(err, client) {
  if (err) { 
    console.log('db not connecting, but inside mongo block', err);
  };
  db = client.db('itnsoutherndelaware');
...
app.post('/sendmail', function(req, res){
  ...
  if (req.body && req.body.pdf){
    ...
    mailOptions = {
        ...
        bcc: 'info@itnsoutherndelaware.org'
    };
  }
